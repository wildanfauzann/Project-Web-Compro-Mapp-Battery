                ...
                <div class="flex items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm">
                            ...
                            <form action="{{ route('logout') }}" method="POST" class="ml-2 pl-4 border-l border-slate-200">
                                @csrf
                                <button type="submit" class="text-sm font-medium text-rose-600 hover:text-rose-800 transition-colors">Logout</button>
                            </form>
                        </div>
                    </div>
                </div>
