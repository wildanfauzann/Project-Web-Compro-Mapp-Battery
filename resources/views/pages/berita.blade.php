    ...
    <main>
        @php
            ...
            $visitStories = [
                [
                    'company' => 'MEGASURYA',
                    'headline' => 'Mendalami Kebutuhan Lapangan Secara Langsung',
                    'description' => 'PT Multidaya Anugrah Perkasa melakukan kunjungan ke PT Megasurya untuk memetakan kebutuhan pelanggan, memperkuat komunikasi teknis, dan memastikan solusi baterai forklift yang diberikan benar-benar sesuai ritme operasional.',
                    'gallery' => [
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                    ],
                ],
                [
                    'company' => 'PT.WINGS',
                    'headline' => 'Evaluasi Bersama untuk Kualitas Layanan Berkelanjutan',
                    'description' => 'Kunjungan ke PT Wings difokuskan pada evaluasi performa layanan, penyelarasan kebutuhan teknis forklift, dan pembentukan strategi pendampingan yang lebih responsif untuk mendukung stabilitas operasional harian.',
                    'gallery' => [
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
                ...
                [
                    'company' => 'WILMAR',
                    'headline' => 'Kolaborasi Strategis untuk Peningkatan Efisiensi',
                    'description' => 'Bersama Wilmar Group, tim kami membahas peningkatan efisiensi pemakaian baterai, pendekatan maintenance berbasis data, serta rencana penguatan layanan purnajual agar performa unit tetap optimal dalam jangka panjang.',
                    'gallery' => [
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
            ...
            $principalStories = [
                [
                    'company' => 'HAWKER 2025',
                    'headline' => 'Principal Visit untuk Peningkatan Standar Layanan',
                    'description' => 'PT Multidaya Anugrah Perkasa bersama principal Hawker melakukan evaluasi lapangan, pembaruan insight teknologi, serta penyelarasan standar layanan agar performa baterai pelanggan tetap konsisten dan andal.',
                    'gallery' => [
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                ...
                [
                    'company' => 'MICROTEX 2023',
                    'headline' => 'Penguatan Kolaborasi Teknis Bersama Principal',
                    'description' => 'Dalam agenda principal visit Microtex, tim kami mendalami pembaruan teknologi baterai forklift, memperkuat koordinasi teknis, dan merumuskan pendekatan implementasi yang lebih presisi sesuai kebutuhan pelanggan di lapangan.',
                    'gallery' => [
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
            ...
            $exhibitionStories = [
                [
                    'company' => 'FORKLIFT INDONESIA 2023',
                    'headline' => 'Komitmen Menampilkan Solusi Industri Terkini',
                    'description' => 'Partisipasi pada Forklift Indonesia 2023 menjadi momentum PT Multidaya Anugrah Perkasa untuk memperkenalkan inovasi produk baterai forklift, memperluas jaringan bisnis, dan menghadirkan solusi energi industri yang relevan bagi kebutuhan pelanggan.',
                    'gallery' => [
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                ...
                [
                    'company' => 'MANUFACTURING SURABAYA 2025',
                    'headline' => 'Memperkenalkan Teknologi Baterai untuk Efisiensi Produksi',
                    'description' => 'Dalam event Manufacturing Surabaya 2025, kami mempresentasikan solusi baterai forklift berperforma tinggi untuk menunjang kelancaran proses produksi, sekaligus membuka kolaborasi baru bersama pelaku manufaktur nasional.',
                    'gallery' => [
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
                ...
                [
                    'company' => 'OIL AND GAS INDONESIA 2024',
                    'headline' => 'Solusi Energi Andal untuk Operasional Industri Berat',
                    'description' => 'Melalui keikutsertaan di Oil and Gas Indonesia 2024, PT Multidaya Anugrah Perkasa menghadirkan teknologi baterai forklift yang tahan terhadap kebutuhan operasional sektor energi dengan tuntutan keamanan dan keandalan tinggi.',
                    'gallery' => [
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
                ...
                [
                    'company' => 'SOLARTECH INDONESIA 2024',
                    'headline' => 'Mendorong Operasional Ramah Lingkungan Berbasis Teknologi',
                    'description' => 'Pada Solartech Indonesia 2024, kami memperkenalkan solusi baterai forklift yang efisien, berorientasi pada keberlanjutan, dan mendukung transisi operasional industri menuju sistem energi yang lebih hijau.',
                    'gallery' => [
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel2.png'),
            ...
            $trainingStories = [
                [
                    'company' => 'KIAT P6',
                    'headline' => 'Training Operasional untuk Tim Lapangan',
                    'description' => 'PT Multidaya Anugrah Perkasa menyelenggarakan training baterai forklift kepada tim Kiat P6 sebagai upaya meningkatkan pemahaman teknis, perawatan, serta penggunaan baterai secara optimal guna mendukung operasional yang lebih efisien dan aman.',
                    'gallery' => [
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                ...
                [
                    'company' => 'KIAT TAMBAK SAWAH DAN KRIAN',
                    'headline' => 'Penguatan Kompetensi untuk Performa Lapangan',
                    'description' => 'Training baterai forklift kepada tim Kiat Tambak Sawah dan Krian difokuskan pada praktik penggunaan yang benar, keselamatan kerja, serta perawatan berkala demi menjaga kelancaran operasional di lapangan.',
                    'gallery' => [
                        asset('images/artikel/artikel2.png'),
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
                ...
                [
                    'company' => 'SAT',
                    'headline' => 'Pendampingan Teknis Berbasis Kebutuhan Operasional',
                    'description' => 'Kegiatan training untuk SAT menitikberatkan pada peningkatan pemahaman teknis, langkah perawatan harian, serta proses penggunaan baterai forklift yang efisien agar performa operasional tetap stabil.',
                    'gallery' => [
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel2.png'),
                ...
                [
                    'company' => 'TFJ',
                    'headline' => 'Program Training untuk Keamanan dan Efisiensi',
                    'description' => 'Pada sesi bersama TFJ, tim kami membahas praktik terbaik penggunaan baterai forklift, prosedur pengecekan keamanan, dan strategi perawatan agar unit tetap andal serta mendukung produktivitas harian.',
                    'gallery' => [
                        asset('images/artikel/artikel1.png'),
                        asset('images/artikel/artikel3.png'),
                        asset('images/artikel/artikel2.png'),
            ...
            $unitTestingStory = [
                'title' => 'Unit - Unit Testing',
                'description' => 'PT Multidaya Anugrah Perkasa sedang melaksanakan kegiatan unit testing pada baterai forklift guna memastikan kualitas, performa, serta keandalan produk sebelum digunakan oleh pelanggan. Kegiatan ini dilakukan sebagai bentuk komitmen perusahaan dalam menjaga standar mutu dan keamanan produk.',
                'gallery' => [
                    asset('images/artikel/artikel3.png'),
                    asset('images/artikel/artikel2.png'),
                    asset('images/artikel/artikel1.png'),
        ...
        <section class="berita-runline-section reveal-on-scroll" aria-label="highlight berjalan">
